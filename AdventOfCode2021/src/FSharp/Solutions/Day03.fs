...
[<TestCase("day03_testinput.txt", ExpectedResult = 198)>]
[<TestCase("day03_input.txt", ExpectedResult = 4138664)>]
let ``Part 1``(fileName) =
...
[<TestCase("day03_testinput.txt", ExpectedResult = 230)>]
[<TestCase("day03_input.txt", ExpectedResult = 4273224)>]
let ``Part 2``(fileName) =
    let lines = readInput fileName
    let part2 =
